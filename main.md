...
- 有机物
  ...
  - 蛋白质
    - 元素组成：C、H、O、N（S）等
    - 基本单位：氨基酸（包括 13 种非必需氨基酸(人体能合成)和8种必需氨基酸(人体不能合成)）
    - 形成：氨基酸→肽链→蛋白质
    - 功能：生命活动的主要承担者
...
- 细胞壁
  ...
  - 主要成分：①植物：纤维素 和果胶   ②细菌：肽聚糖   ③真菌：几丁质
  - 主要功能：支持和保护

- 细胞膜

  - 主要功能：①将细胞与外界环境分隔开  ②控制物质进出细胞  ③进行细胞间的**信息交流**
  - 主要成分：①脂质：主要含有磷脂   ②蛋白质：种类和数量越多，细胞膜**功能越复杂**   ③糖被：分布在膜**外侧**的少量糖类分子，与蛋白质结合形成糖蛋白，脂质结合形成糖脂
  - 流动镶嵌模型
    - 基本支架：**磷脂双分子层**
    - 结构特点：具有**一定的流动性**
    - 功能特点：具有**选择透过性**
...
- 细胞质
  ...
  - 细胞骨架
    ...
    - 本质：**蛋白质纤维**
    - 功能：①维持细胞**形态**   ②**锚定**并**支撑**多种细胞器   ③与细胞运动、分裂、分化以及**物质运输**、**能量转化**、**信息传递**等生命活动密切相关
...
- 细胞核
  ...
  - 结构
    ...
    - 染色质：①主要由DNA和蛋白质组成   ②易被**碱性染料** 染成深色   ③与染色体的关系：**同一物质在细胞不同时期的两种存在状态**
    - 核孔：实现核质之间频繁的物质交换和**信息交流**
  - 功能：遗传信息库、细胞**代谢和遗传**的控制中心
...
- 成熟植物细胞
  - 方式：**渗透作用**
  - 质壁分离及复原
    - 原理：①原生质层相当于一层半透膜   ②原生质层比细胞壁的**伸缩性大**   ③细胞液与外界溶液存在浓度差
...
- 被动运输
  ...
  - 分类
    ...
    - 协助扩散
      - 定义：借助膜上的**通道蛋白**(转运蛋白)进出细胞的物质扩散方式
      - 举例：离子和一些小分子有机物如葡萄糖、氨基酸的**顺**浓度梯度运输、水经过通道蛋白的运输
      - 影响因素：浓度差、**通道蛋白**(转运蛋白)数量
- 主动运输
  - 定义：物质**逆**浓度梯度进行跨膜运输，需要**载体蛋白**(转运蛋白)的协助，同时还需要消耗细胞内化学反应所释放的能量
...
-  类型
   ...
   - 无氧呼吸
     - 场所：**细胞质基质**
     - 总反应式
       - C₆H₁₂O₆ → 2C₂H₅OH + 2CO₂ + 少量能量  （大部分植物，酵母菌等）
       - C₆H₁₂O₆ → 2C₃H₆O₃ + 少量能量                   （高等动物，乳酸菌以及少数植物器官如马铃薯块茎，甜菜块根，玉米胚等）
...
- 细胞周期
  ...
  - 时期
    ...
    - 分裂期
      ...
      - 后期："粒裂数增均两极"（着丝粒分裂，**染色体**数目倍增，姐妹染色单体被纺锤丝牵引移向两极）
...
- 基因
  ...
  - 等位基因：同源染色体相同位置上控制**相对性状**的基因（字母相同，不分大小写）
  - 非等位基因（字母不同）
    - 同源染色体上的非等位基因
    - **非同源染色体**上的非等位基因
...
- 染色体数目的变异：以一套完整的**染色体组**为基数成倍地增加或成套地减少
- 染色体结构的变异：类型包括：**缺失、重复、倒位、易位**，结果是：染色体上基因的**数目或排列顺序**发生改变
- 单倍体：由配子发育而来。无论体细胞有多少染色体组
- 二/多倍体：由受精卵发育而来。体细胞有几个染色体组就是几倍体
- 单/奇数数倍体不可育，偶数倍体可育
...
- 观点：①生物是由原始的共同祖先逐渐进化而来的   ②进化方向：简单到复杂、低等到高等、水生到陆生

### 生物进化的证据汇总表

| 证据类别           | 研究对象 / 定义                                              |
| :----------------- | :----------------------------------------------------------- |
| 化石证据           | **最直接、最重要**的证据。证实生物进化遵循从简单到复杂、从低等到高等的规律 |
| 比较解剖学证据     | 研究比较不同生物类群（如脊椎动物）器官、系统的**形态和结构**<br>结论：具有共同祖先的生物为适应不同环境，向不同方向进化 |
| 胚胎学证据         | 研究动植物**胚胎的形成和发育过程**                           |
| 细胞和分子水平证据 | 细胞水平：研究细胞的物质和结构基础、生命活动<br>分子水平：研究**DNA**、**蛋白质**等生物大分子 |

### 自然选择学说

- 含义：①生物的形态结构适合于完成**一定的功能**   ②生物的形态、结构及其功能适合于该生物在一定环境中**生存和繁殖**
- 特点：①普遍性：所有生物都有适应环境的特征   ②相对性/局限性：当环境条件改变时，适应可能变得不适应

- 达尔文的解释：适应的来源是**可遗传变异**，适应是**自然选择**的结果

> 适应具有相对性，是**遗传物质的稳定性和环境条件的变化相互作用**的结果
...
- 外周神经系统
  - 按部位：**脑**神经（主要分布在头面部）和**脊**神经（主要分布在躯干）
  - 按功能
    - 传入神经（感觉神经）
...
- 特点：①通过体液进行运输   ②作用于**靶器官、靶细胞**   ③作为信使传递信息   ④**微量和高效**

## 体液调节与神经调节的关系

### 体液调节

**激素**、**组胺**、NO、CO₂等化学物质，通过体液传送的方式对生命活动进行的调节
...
- 血糖的来源和去路
  ...
  - 去路：**氧化分解**、合成肝糖原和肌糖原、转化为甘油三酯等非糖物质
- 调节方式：神经—体液调节
- 激素
  - 唯一降血糖的激素：**胰岛素**
...
- 体液免疫
  - 作用对象：游离于体液中的抗原
  - 免疫细胞：主要是**B**细胞（两个信号：病原体的直接接触；辅助性T细胞表面的特定分发定生变化与B细胞的结合）
  - 作用方式：**抗体**与抗原特异性结合
- 细胞免疫
  - 作用对象：**被病原体感染**的细胞、癌细胞、异体移植的器官等
  - 免疫细胞：主要是**细胞毒性T**细胞
  - 作用方式：细胞毒性T细胞与靶细胞密切接触，**裂解**靶细胞
  - 记忆细胞的作用：当相同抗原再次入侵时，记忆细胞能迅速增值分化，形成相应效应细胞，迅速高效地产生免疫反应
...
- 分为**"J"形增长**和**"S"形增长**
- 增长率：单位时间新增个体数与原有个体数的比值
- 增长速率：单位时间的新增个体数
- K值：一定的环境条件所能维持的种群最大数量，由环境决定
...
- > **人类的活动** 往往使种群演替，按照不同于自然演替的速度和方向进行
  >
...
- | 原理     | 内容                                                         | 措施                                                         | 实例                                                         |
  | :------- | :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
  | **自生** | 由生物组分产生的**自组织、自我优化、自我调节、自我更新和维持**。 | ①有效选择生物组分并合理布设；<br>②创造有益于生物组分的生长、发育、繁殖，以及它们形成互利共存关系的条件。 | 湿地修复时，选择污染净化能力较强的多种水生植物，考虑它们的生态位差异，以及种间关系；移除有毒物质和沉积物，**改善水体环境**。 |
  | **循环** | 在生态工程中促进系统中的物质迁移与转化，既保证各个环节的物质迁移顺畅，也保证主要物质或元素的转化率较高。 | 通过系统设计实现不断循环，使前一环节产生的废物尽可能地被后一环节利用，减少整个生产环节“废物”的产生。 | “**无废弃物农业**”中的物质循环再生。                         |
  | **协调** | 生物与环境、生物与生物的协调与适应。                         | 需考虑**环境容纳量**，生物数量不应超过环境承载力的限度。     | 我国西北一些地区种植的杨树林因不适应环境而残败。             |
  | **整体** | 自然生态系统是通过生物与环境、生物与生物之间的协同进化而形成的一个不可分割的有机整体。 | ①遵循自然生态系统的规律，各组分之间要有适当的比例，不同组分之间应构成有序的结构，通过改变和优化结构，达到改善系统功能的目的；<br>②进行生态工程建设时，要考虑**经济和社会等系统的影响**。 | 进行林业工程建设时，一方面要号召农民种树，另一方面要考虑贫困地区农民的生活问题。 |

> 生态工程原理的一般判定方法：
>
> 1. 强调物质循环、废物利用、减轻环境污染 $\rightarrow$ **循环原理**
> 2. 体现物种多，营养关系复杂；涉及种间关系，物种的合理搭配 $\rightarrow$ **自生原理**
> 3. 强调生物与环境的协调与平衡，涉及环境承载力 $\rightarrow$ **协调原理**
> 4. 涉及自然、经济和社会，如帮助农民增加收入 $\rightarrow$ **整体原理**
...
- 类型
  - 腐乳：利用**毛霉**(真菌)等微生物将蛋白质分解为**小分子肽**和氨基酸
  - 泡菜：利用**乳酸菌**(细菌)的无氧呼吸
  - 果酒和果醋
    - 果酒：酵母菌(真菌)的无氧呼吸，**18~30**℃
    - 果醋
      - 醋酸菌（好氧细菌），**30~35**℃
...
- 培养基
  ...
  - 牛肉膏、蛋白胨：同时提供碳源、氮源、维生素
  
  - | **培养基种类**   | **特点**                                                     | **主要用途**                                                 |
    | ---------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
    | **液体培养基**   | 不加凝固剂                                                   | 工业生产、扩大培养                                           |
    | **半固体培养基** | 加少量凝固剂                                                 | 观察微生物的**运动**、分类、鉴定                             |
    | **固体培养基**   | 加一定量的凝固剂                                             | 微生物**分离**、**鉴定**、**活菌计数**、保藏菌种             |
    | **选择培养基**   | 通过加入某些物质或减少特定成分，**允许特定种类的微生物生长，抑制或阻止其他种类微生物生长** | 培养、分离出特定微生物                                       |
    | **鉴别培养基**   | 在培养基中加入某种指示剂或化学药品，用以鉴别不同种类的微生物 | 鉴别不同种类微生物 [如伊红—亚甲蓝培养基可鉴别大肠杆菌（深紫色），刚果红培养基可鉴别纤维素分解菌] |
...
- 纯培养
  1. 培养基：配制培养基→灭菌→倒平板（平板凝固后需**倒置**）
  2. 接种：
  
       - **平板划线法**：可分离、不可计数（**不用**稀释）
       - **稀释涂布平板法**：可分离、可计数
  3. 培养
...
- 原理：**植物细胞的全能性**
- 过程：$\ce{外植体 \xrightarrow{脱分化（不需要光）} 愈伤组织 \xrightarrow{再分化（需要光）} 幼根、幼芽 \rightarrow 植株}$
- 体内细胞为表达全能性的原因：在特定的时间和空间条件下，细胞中的基因会选择性的表达
...
- 意义：打破生殖隔离，实现远缘杂交育种
- 培养基中要添加蔗糖溶液且浓度略大于原生质体内的浓度（①为原生质体提供营养     ②维持一定的渗透压，使原生质体保持正常的形态）
...
- 条件：营养条件(含**血清**等天然成分)、无菌、**无毒**的环境；适宜的温度、pH和**渗透压**；气体环境：95%的空气和5%的CO₂(维持pH)
...
- 精子准备
  - 精子获能：在雌性**生殖道**(主要是子宫和输卵管)或人工配制的获能液(常见有效成分有肝素、$Ca^{2+}$载体)中发生相应的生理变化，获得受精的能力
  - 卵子的成熟：需发育至MⅡ期
...
- 体外受精和早期胚胎培养
- 胚胎移植（时期：桑葚胚和囊胚）
  - 两次处理：**同期发情处理**(促性腺激素)、超数排卵处理(孕激素)
  - 两次检查：胚胎质量检查、**妊娠检查**
- 胚胎分割：一般对**桑葚胚**或囊胚进行分割，后者要注意对**内细胞团**均等分割

> 细胞全能性：**指已经分化的细胞，仍然具有发育成完整个体的潜能**（原因：细胞核内含有该物种发育所需的**全部基因**）
...
- 限制酶
  ...
  - 结果：产生黏性末端或平末端
- DNA 连接酶
  - 功能：连接 具有平末端或互补粘性末端的DNA 片段，恢复磷酸二酯键
...
- 原理： DNA的半保留复制
- 条件：缓冲溶液(含有$Mg^{2+}$)、DNA模板、2种引物、4种脱氧核苷酸(dNTPs)、耐高温的DNA聚合酶(Taq酶)
- 过程：变性(超过90℃)、复性(50℃左右)、延伸(72℃左右)
- 检测：琼脂糖凝胶电泳
- 引物：本质为短链核苷酸作用是将DNA聚合酶。能够使引物的3‘端开始连接脱氧核苷酸，5’端可以加修饰
...
[^1]:模型：人们为了某种特定的目的，而对认识对象所做的一种简化的概括性的描述
...
- 三种启动子
  ...
  2. 诱导型启动子：活性受到特定物理或化学信号的诱导和关闭，能够响应环境变化
